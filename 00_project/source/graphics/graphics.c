...
void show_settings(int games_played, int games_won, int higher_played){
	...
	printDigit(BG_MAP_RAM_SUB(0) , higher_played_hundreds, 10, 16);
	printDigit(BG_MAP_RAM_SUB(0) , higher_played_dozens, 14, 16);
	printDigit(BG_MAP_RAM_SUB(0) , higher_played_units, 18, 16);
}
