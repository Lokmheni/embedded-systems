...
void set_healthbars(){
	...
	dmaCopy(GreenTile, &BG_TILE_RAM_SUB(3)[0], 64);
	dmaCopy(BlueTile, &BG_TILE_RAM_SUB(3)[32], 64);
	dmaCopy(WhiteTile, &BG_TILE_RAM_SUB(3)[64], 64);
	dmaCopy(BlackTile, &BG_TILE_RAM_SUB(3)[96], 64);
	dmaCopy(RedTile, &BG_TILE_RAM_SUB(3)[128], 64);
