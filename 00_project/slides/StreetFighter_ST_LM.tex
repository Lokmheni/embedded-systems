...
\frame{
    ...
    \begin{itemize}
        ...
        \item Graphics
              \begin{itemize}
                  \item Main screen: Mode 5  with Backgrounds 0 and 2 active (respectively Tiled and Extended Rotoscale modes)
                  \item Sub screen: Mode 5 with Backgrounds 0, 1 and 2 active (respectively Tiled and Extended Rotoscale modes)
              \end{itemize}
