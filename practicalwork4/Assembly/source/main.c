...
int main( void )
{
    ...
    printf(
        ...
        "\t%d\t%d\t%d\n\n"
        "\t%d\t%d\t%d\n\n",
        MatR[ 0 ], MatR[ 1 ], MatR[ 2 ], MatR[ 3 ], MatR[ 4 ], MatR[ 5 ], MatR[ 6 ],
        MatR[ 7 ], MatR[ 8 ] );
    ...
    */
    ...
    /*
        ...
        // 3 bits for the integer part, 12 for the decimal and one for the
       sign.
        // The assembler code that will be implemented has to consider this
       fixed
        ...
        short input[50]={ 1840, 2701, 3085, 3296, 119, 3194, 2323,
                        ...
                        2472};
        short output[50];
        short coef[11]={ -235, -246, -272, -310, -343, 3738, -343,-310, -272,
       -246, -235};
