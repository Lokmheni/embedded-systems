...
// members
static u16* P_Graphics_mainBuffer;
static u16* P_Graphics_subBuffer;
static int  P_Graphics_mainW;
static int  P_Graphics_mainH;
static int  P_Graphics_subW;
static int  P_Graphics_subH;
...
-	u16 color: This parameter is the color like explained in the previous
    function.
*/
void DrawHorizontalLine( enum BUFFER_TYPE bT, int x, int x2, int y,
                         u16 color );


/*
    This function draws a vertical line of 1 pixel width between the
coordinates (x,y) and (x,y2) with the given color.
